...
--sorgu icinde sorguya subquery denir
    ...
    --Personel say?s? 15.000'den cok olan sirketlerin isimlerini
    --ve cal?san personelin isimlerini listeleyin
...
/*==========================AGGREGATE METOT KULLANIMI========================*/
    ...
    --Aggregate metodlar? (SUM, COUNT, MIN; MAX, AVG) Subquery icinde kullan?labilir.
    --Ancak, sorgu tek bir deger donduruyor olmal?d?r.
    
/* -----------------------------------------------------------------------------
  ORNEK4: Her sirketin ismini, personel say?s?n? ve o ?irkete ait personelin
  toplam maa??n? listeleyen bir Sorgu yaziniz.
 -----------------------------------------------------------------------------*/
...
/* ----------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/      
    SELECT sirket_adi, personel_sayisi, (SELECT MIN(maas)FROM personel
                                         WHERE sirket_adi = sirket)
                                         AS min_maas,
